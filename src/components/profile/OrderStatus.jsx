      ...
      {loadingOrders ? (
        ...
        <>
          {orders && orders.length === 0 ? (
            ...
            <>
              {openedModal && <InvoiceModal loading={loading} invoice={invoice} formatter={formatter} openedModal={openedModal} setOpenedModal={setOpenedModal} />}
                    ...
                    <tr>
                      <td>
                        <ActionIcon variant="transparent" onClick={() => buttonOpenHandler(order._id)}>
                          {isOpen.status && isOpen.id === order._id ? <IconChevronDown size={26} /> : <IconChevronRight size={26} />}
                        </ActionIcon>
                      </td>
                      ...
                      <td>{order.status}</td>
                      <td>
                        <Button variant="gradient" bg="#a41e1f" onClick={() => openedModalHandler(order._id)}>
                          Invoices
                        </Button>
                      </td>
                    </tr>
